 ...
 * @author meh
 */
public class IN4 extends JFrame implements ActionListener{
 ...
 @Override
    public void actionPerformed(ActionEvent e){
        ...
        this.setVisible(false);
         ...
         IN4S IN4S= new IN4S();
         IN4S.setBounds(0,0,600,360);
         IN4S.setResizable(false);
        IN4S.setVisible(true);
        IN4S.setLocationRelativeTo(null);
        this.setVisible(false);
