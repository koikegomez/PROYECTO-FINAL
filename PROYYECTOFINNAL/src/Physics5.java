 ...
 * @author meh
 */
public class Physics5 extends JFrame implements ActionListener{
...
setLayout(null);
    ...
    txarea1 = new JTextArea("PROBLEM #5"); 
 ...
 @Override
    public void actionPerformed(ActionEvent e){
        ...
        this.setVisible(false);
         ...
         Physics5s Phy5s= new Physics5s();
         Phy5s.setBounds(0,0,600,360);
         Phy5s.setResizable(false);
        Phy5s.setVisible(true);
        Phy5s.setLocationRelativeTo(null);
        this.setVisible(false);
