 ...
 * @author meh
 */
public class Math3s extends JFrame implements ActionListener{
...
setLayout(null);
 ...
 @Override
    public void actionPerformed(ActionEvent e){
        ...
        Math4.setBounds(0, 0, 600, 360);
        Math4.setVisible(true);
        Math4.setResizable(false);
        Math4.setLocationRelativeTo(null);
