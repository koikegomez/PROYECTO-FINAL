 ...
 * @author meh
 */
public class Physics1 extends JFrame implements ActionListener{
 ...
 @Override
    public void actionPerformed(ActionEvent e){
        ...
        this.setVisible(false);
         ...
         Physics1s Phy1s= new Physics1s();
         Phy1s.setBounds(0,0,600,360);
         Phy1s.setResizable(false);
        Phy1s.setVisible(true);
        Phy1s.setLocationRelativeTo(null);
        this.setVisible(false);
