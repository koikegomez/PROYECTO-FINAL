 ...
 * @author meh
 */
public class Math7 extends JFrame implements ActionListener{
 ...
 @Override
    public void actionPerformed(ActionEvent e){
        ...
        this.setVisible(false);
         ...
         Math7s Ma7s= new Math7s();
         Ma7s.setBounds(0,0,600,360);
         Ma7s.setResizable(false);
        Ma7s.setVisible(true);
        Ma7s.setLocationRelativeTo(null);
        this.setVisible(false);
