 ...
 * @author meh
 */
public class Physics10s extends JFrame implements ActionListener{
...
setLayout(null);
    ...
    lb1 = new JLabel("PROBLEM #10 SOLVED");
    ...
    txarea1.setText("          PROBLEM #10"
            + "\n\n A body is thrown vertically downward with an initial velocity of 7 m / sec."
            + " \n  What will be your speed after having descended 3 sec ?."
            + "\n\n ANSWER:"
            + "\n\n Vo = 7m/s   g = 9.8m/s²     t = 3s "
            + "\n\n Vf = Vo + g t"
            + "\n\n Vf = 7m/s + 29.4m/s"
            + "\n\n Vf = 36,4m/s");
